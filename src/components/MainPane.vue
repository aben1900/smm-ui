<template>
  <div class="app-wrapper" style="font-family:'微软雅黑';" >
      <el-tabs v-model="mainActiveName" @tab-click="handleClick" class="el_tabs">
          <el-tab-pane label="主页面" name="firstMainTab" class="el_tab_pane">
              <div class="el_header">
                  <div>
                      <label style="font-size: 40px;">来吧，让我们为梦想窒息! </label>
